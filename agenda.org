...
** Overview
   ...
   |----------+----------------------------------------------|
   | Practice | Emacs tutorial - Shell inside Emacs          |
   |          | File system management: create .emacs file   |

** Objectives

   * [ ] Summarize foundations of operating systems
     
   * [ ] Understand how GNU Emacs (and Linux) file management works

   * [ ] Create an Emacs ~.emacs~ configuration file
...
** Summary foundations of operating systems
   ...
   7) Process management includes creating and deleting processes, and
      providing process communication and synchronization.
...
** GNU Emacs practice: creating a config file
** What's next?
