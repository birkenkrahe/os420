...
* w4s7 (02/01/22)
  ...
  * [[https://www.gnu.org/software/coreutils/manual/html_node/mv-invocation.html#mv-invocation][GNU manual page for ~mv~]]

** TODO Fanboys

** TODO Theory/practice areas: networking (ssh), memory mgmt (cpu.c), process mgmt
...
* w4s8 (02/03/22)
  ...
  * [[https://lyon.on.worldcat.org/search?queryString=raspberry+Pi][Raspberry Pi Ebooks in the Mabee-Simpson library]]

  * [[https://youtu.be/ZDfhcA0SCiM][Raspberry Pi Projects]] ([[tjfree][TJ Free, 2020]]).
