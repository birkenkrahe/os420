...
** Overview
  ...
  | HOW      | WHAT                                          |
  |----------+-----------------------------------------------|
  | Review   | [[file:~/Documents/GitHub/org/FAQ.org::Completing the GitHub "hello world" exercise][GitHub Hello World exercise]]                   |
  | Lecture  | What operating systems do                     |
  | Practice | [[file:~/Documents/GitHub/org/FAQ.org:: How to install Emacs (+ESS) under Windows and MacOS][Install GNU Emacs]]                             |
...
* Week 2 - January 18 , 2022    
** Overview

  | HOW      | WHAT                                          |
  |----------+-----------------------------------------------|
  | Review   | Quiz: course, OS foundations / GNU Emacs      |
  | Lecture  | Interrupt basics                              |
  | Demo     | [[https://www.gnu.org/software/emacs/tour/][Emacs guided tour]]                             |
  | Self     | [[https://www.stolaf.edu/people/humke/UNIX/emacs-tutorial.html][Work through the Emacs onboard tutorial (18p)]] |

  /Nachtrag: watch [[file:followup.org::Lecture on OS foundations][History of Databases]]/
