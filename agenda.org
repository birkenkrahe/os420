...
** Understanding the shell
   ...
   * Look up the man page for ~bash~ with the command ~man bash~ [fn:3].
...
** Overview
   ...
   |-----------+-------------------------------------------------|
   | Poll      | [[./notes.org::FAQ][Should you update your operating system?]]        |

** Objectives

   * [ ] Discussion: should you upgrade your OS?
...
** Shell warm-up exercise
  ...
  | Leave ~less~                                                  |
   ...
   [[file:~/GitHub/admin/spring22/os420/assignments.org::Shell warm-up classroom assignment - solution][Solution]] / Video
...
** Manipulating files and directories
   ...
   * [X] Which command would show the top directories of the OS?[fn:6]
...
** TODO Manipulating data
   ...
   * Viewing commands: ~cat~, ~more~, ~less~[fn:7].
...
[fn:7]~less~ is faster than ~more~ because it does not load the entire
