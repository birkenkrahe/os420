...
** Overview
   ...
   |-------------+----------------------------------------------------|
   | Pi Practice | Understanding the shell                            |
   |             | Understanding and navigating the file system       |

** Objectives

   * [ ] Review Introduction to the shell - Files and folders (Quiz 3)

   * [ ] Getting OS release information

   * [ ] Understand the shell(s) - Unix man pages
