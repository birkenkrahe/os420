...
* Introduction to bash scripting  (12-Apr)
** Emacs tip
...
* Sophisticated file searches with regular expressions
* Compiling source code from scratch
* Review: quizzes, tests, final exam preparation (3-May)
* References
