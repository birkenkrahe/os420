...
<<<<<<< HEAD
* NEXT ~ssh~ and ~wget~ and review quiz 7-9 - w15s26 (26-Apr)
...
** Networking 2
   ...
   * [ ] Did anyone look at the "Bonus features" (~rclone~ / ~Tramp~)?
   * [ ] See also "[[https://www.raspberrypi.com/documentation/computers/remote-access.html#remote-access][Remotely accessing your Raspberry Pi]]" (networking)
   * [ ] ~wget~ for non-interactive network downloads
   * [ ] ~ssh~ for remote shell login
...
* TODO Finding, archiving, compressing - w15s27 (28-Apr)
* TODO Compiling from source, and final exam preparation (3-May)
=======
* TODO Archiving and backup - w15s26 (26-Apr)

  * [ ] Finish networking: ~ftp~ session, ~ssh~ session
