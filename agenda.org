...
* Manipulating files, getting (more) help - w8s13 (03/01/22)
** Objectives
   * [ ] Learn the language of cows
   * [ ] Review: quiz 4-5 (comment/complain/challenge)
   * [ ] Review: warming up exercise "N'est pas une pipe"
   * [ ] Lecture: standard streams
   * [ ] Practice: getting started with interactive notebooks
...
** Standard streams
   ...
   * This presumes that you defined an alias ~chap='[cmd]'~. Try it!
...
* w8s14
  ...
  * [[file:~/Documents/GitHub/admin/spring22/os420/agenda.org::README][plan]]
