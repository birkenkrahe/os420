...
* Mid-term speech, REPLit, redirection revisited - w8s14 (3-Mar)
** Objectives
...
* Redirection revisited 2 - w9s15 (8-Mar)
** News
   ...
   * [ ] [[https://www.maketecheasier.com/create-symbolic-links-windows10/][Creating Symlinks in Windows 10]]

** Objectives

   * [ ] Improve your grade with a project
   * [ ] Learning to create symlinks in Windows
