...
*** Examples
    ...
    On Windoze these work only because I have the CYGWIN bundle
    installed, which comes with man of the most important functions.

    #+begin_src bash
      echo "to be or not to be" > text
      cat text
      echo "
    #+end_src
    ...
    #+begin_src bash
      echo "to be or not to be" | wc -w
    #+end_src

    #+RESULTS:
    : 6

** TODO Getting more help
