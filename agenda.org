...
** Overview
   ...
   | Review    | Shell warm-up exercise                          |
   |-----------+-------------------------------------------------|
   | Practice  | Navigating the file system (DataCamp)           |
   |           | Manipulate files and folders (DataCamp)         |
   |-----------+-------------------------------------------------|
...
** Objectives
   ...
   * [ ] Understand test rules and content

** Shell warm-up exercise

   Complete the exercise on the command line:

   * go to your ~$home~ directory, ~/home/pi~
   * use ~wget~ to fetch the file ~https://github.com/birkenkrahe/os420/sample.txt
   * make a sub directory titled ~practice~
   * change to ~/home/pi/practice~
   * verify that you're there with ~pwd~
   * move ~sample.txt~ to your current directory
   * make

   make 4 copies of sample.txt
   *

** Manipulating files and directories

   See also: [[https://campus.datacamp.com/courses/introduction-to-shell/manipulating-files-and-directories?ex=1][DataCamp chapter]]
...
** TODO Manipulating data
   ...
   See also: [[https://campus.datacamp.com/courses/introduction-to-shell/manipulating-data?ex=1][DataCamp chapter]]

   * Viewing commands: ~cat~, ~more~, ~less~[fn:6].
...
** Objectives
   ...
   * [ ] Know Raspberry Pi: history & hardware

   * [ ] Understand GPIOs and how to see and control them

** TODO Raspberry Pi hardware & history: history
   DEADLINE: <2022-02-08 Tue>
...
** Test info
   ...
   * Online in Schoology
   * Quizzes 1-3 are unpublished during the test
   * 5 easy questions (1 new)
   * 5 hard questions (1 new)
   * An essay question
   * Time = 45 min
...
[fn:6]~less~ is faster than ~more~ because it does not load the entire
