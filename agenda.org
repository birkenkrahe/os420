...
** Objectives
   ...
   * [ ] Learn to manipulate files and folders
...
** Understanding the shell
   ...
   want the computer to do, you can combine old commands to create new
   ones and automate repetitive operations with just a few
   keystrokes."
   #+end_quote

   * The shell is just another program to pass commands to the OS
