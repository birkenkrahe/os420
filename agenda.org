...
** Agenda
   ...
   * [ ] How to [[https://www.maketecheasier.com/create-symbolic-links-windows10/][Create Symlinks in Windows 10]] (it's not impossible!)
   * [ ] Improve your grade with a project ([[https://github.com/birkenkrahe/org/blob/master/FAQ.org#how-can-i-improve-my-mid-term-grades][see FAQ]])
   * [ ] Preparations for test 2 (Tue 15-Mar)
   * [ ] Review Docker/container technology ([[file:notes.org::Docker][notes]])
   * [ ] Complete Manipulate Files notebook on your own!
