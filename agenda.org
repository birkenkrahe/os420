...
* Test review - w6s10 (02/15/22)
** News

   * Eliminated some DataCamp assignments (bash scripting)
...
** Test results - stats and plots
   ...
   * I am an obsessive fact-checker. When checking the stats with R, I
     ...
     #+begin_src R :exports both :session :results output
       results <- c(12.13,13.87,12.28,13.9,9.88,8.62,14.67,
                    13.27,10.48,17.33,9.67,13.07,15.67,16.75,
                    17.27,12.8,15.93,14.33,12.73,12.38,14.53,11.7)
       length(results)
       sd(results)
       summary(results)
     #+end_src
     ...
     :    8.62   12.17   13.17   13.33   14.63   17.33
