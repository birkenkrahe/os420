...
** Review quiz 7-9
   ...
   * [ ] Quiz 7: Permissions
   * [ ] Quiz 8: Processes 
   * [ ] Quiz 9: Bash scripting

   * Test 3 will have 15 questions and last 30 minutes
   * Open between Thu 6 pm to Sat 8 am
   * ALL questions for test 3 and final exam are KNOWN
     (in principle - I will make small modifications)
*  ~wget~ and ~ssh~ - w15s27 (28-Apr)
** Networking 2

   *DOWNLOAD UPDATED FILE ~networking.org~ FROM GDRIVE*
