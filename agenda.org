...
* Standard streams, Notebook tutorial - w8s13 (03/01/22)
** Objectives
...
** ~bash~ Read-Eval-Printing-Loop in the cloud
   ...
   * replit.com uses a Nix Docker container to emulate the shell (this
     is a fifth (and with Docker, a sixth) way to get hold of Linux
     tools...do you remember the others?[fn:1])
